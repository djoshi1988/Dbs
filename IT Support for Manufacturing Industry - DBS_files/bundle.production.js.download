...
const u=2e5
function c(e){return function(t){e&&(t=e(t))
...
t.extra={message:"Error processing Sentry (extra data not serializable). Existing extra data removed."}}return t}}function p(e,t={}){void 0===s.default.bender&&"prod"!==o.default.getShort("sentry")&&console.warn("[raven-hubspot] `project` and `release` Sentry tags will not be set. See: HubSpot/raven-hubspot/issues/40")
...
const p=o.default.getShort("sentry")
let d
try{d=!!(document&&document.cookie&&document.cookie.includes("hs_selenium"))}catch(e){d=!1}const f=(0,l.getDeployInfo)()
i.default.config(e,{release:r&&r.currentProjectVersion,ignoreErrors:t.ignoreErrors,ignoreUrls:t.ignoreUrls,sampleRate:t.sampleRate,environment:p,tags:Object.assign({env:p,project:f?f.deployable:r&&r.currentProject,portalId:a.default.get(),hublet:o.default.getHublet(),isAcceptanceTest:d},t.tags),breadcrumbCallback:t.breadcrumbCallback||(e=>e),autoBreadcrumbs:{console:!1},dataCallback:c(t.dataCallback),shouldSendCallback:t.shouldSendCallback||(()=>!0),stacktrace:t.stacktrace}).install()
...
r.r(t)
r.d(t,{Raven:function(){return B}})
var n=r("Zi/v"),o=r.n(n),a=r("uESY"),i=r("GKWQ"),s=r("vtEu"),l=r("HYfT"),{getCorrelationIdFromResponse:u,getCorrelationIdFromXHR:c}=r("16j7"),p=r("uESY"),d=p.isError,f=p.isObject,h=(f=p.isObject,p.isErrorEvent),g=p.isUndefined,b=p.isFunction,v=p.isString,m=p.isEmptyObject,_=p.each,x=p.objectMerge,y=p.truncate,E=(p.objectFrozen,p.hasKey),w=p.joinRegExp,S=p.urlencode,k=p.uuid4,C=p.isSameException,O=p.isSameStacktrace,R=p.parseUrl,j=p.fill,P=r("sCFE").wrapMethod,T="source protocol user pass host port path".split(" "),D=/^(?:(\w+):)?\/\/(?:(\w+)(:\w+)?@)?([\w\.-]+)(?::(\d+))?(\/.*)/
function I(){return+new Date}var U="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},q=U.document,N=U.navigator
function M(e,t){return b(t)?function(r){return t(r,e)}:t}function B(){this._hasJSON=!("object"!=typeof JSON||!JSON.stringify)
this._hasDocument=!g(q)
this._hasNavigator=!g(N)
...
this._originalConsole=U.console||{}
...
this._resetBackoff()
for(var e in this._originalConsole)this._originalConsoleMethods[e]=this._originalConsole[e]}B.prototype={VERSION:"3.19.1",debug:!1,TraceKit:i,config:function(e,t){var r=this
...
"[object Object]"==={}.toString.call(a)?a=x(o,a):!1!==a&&(a=o)
n.autoBreadcrumbs=a
var s={tryCatch:!0},l=n.instrument
"[object Object]"==={}.toString.call(l)?l=x(s,l):!1!==l&&(l=s)
n.instrument=l
...
if(n&&o||a)return this.captureMessage(e,x({trimHeadFrames:1,stacktrace:!0},t))
h(e)&&(e=e.error)
var s=e.cause
...
return this}}},captureBreadcrumb:function(e){var t=x({timestamp:I()/1e3},e)
...
this._logDebug("error","Error: Raven has not been configured.")}return!1}return!0},afterLoad:function(){var e=U.RavenConfig
e&&this.config(e.dsn,e.config).install()},showReportDialog:function(e){if(q){var t=(e=e||{}).eventId||this.lastEventId()
...
a.email&&(o+="&email="+n(a.email))}var i=this._getGlobalServer(this._parseDSN(r)),s=q.createElement("script")
s.async=!0
s.src=i+"/api/embed/error-page/"+o;(q.head||q.body).appendChild(s)}},_processErrorCause:function(e){try{var t=this,r=i.computeStackTrace(e),n=this._prepareFrames(r,{}).map((e=>({file:e.filename,methodName:e.function||"?",lineNumber:e.lineno,column:e.colno})))
...
for(n in t)E(t,n)&&(r[n]=t[n])
if(q.createEvent)q.dispatchEvent(r)
else try{q.fireEvent("on"+r.eventType.toLowerCase(),r)}catch(e){}}},_breadcrumbEventHandler:function(e){var t=this
...
function o(r){var o=U[r]&&U[r].prototype
if(o&&o.hasOwnProperty&&o.hasOwnProperty("addEventListener")){j(o,"addEventListener",(function(t){return function(o,a,i,s){try{a&&a.handleEvent&&(a.handleEvent=e.wrap(a.handleEvent))}catch(e){}var l,u,c
...
j(o,"removeEventListener",(function(e){return function(t,r,n,o){try{r=r&&(r.__raven_wrapper__?r.__raven_wrapper__:r)}catch(e){}return e.call(this,t,r,n,o)}}),t)}}j(U,"setTimeout",r,t)
j(U,"setInterval",r,t)
U.requestAnimationFrame&&j(U,"requestAnimationFrame",(function(t){return function(r){return t(e.wrap(r))}}),t)
...
function n(t,r){t in r&&b(r[t])&&j(r,t,(function(t){return e.wrap(t)}))}if(t.xhr&&"XMLHttpRequest"in U){var o=XMLHttpRequest.prototype
j(o,"open",(function(t){return function(r,n){v(n)&&-1===n.indexOf(e._globalKey)&&(this.__raven_xhr={method:r,url:n,status_code:null})
return t.apply(this,arguments)}}),r)
j(o,"send",(function(t){return function(r){var o=this
...
"onreadystatechange"in o&&b(o.onreadystatechange)?j(o,"onreadystatechange",(function(t){return e.wrap(t,void 0,a)})):o.onreadystatechange=a
return t.apply(this,arguments)}}),r)}t.xhr&&"fetch"in U&&j(U,"fetch",(function(t){return function(r,n){for(var o=new Array(arguments.length),a=0;a<o.length;++a)o[a]=arguments[a]
var i,s=o[0],l="GET"
if("string"==typeof s)i=s
else if("Request"in U&&s instanceof U.Request){i=s.url
...
t&&(c.correlationId=t)
return e}))}}),r)
if(t.dom&&this._hasDocument)if(q.addEventListener){q.addEventListener("click",e._breadcrumbEventHandler("click"),!1)
q.addEventListener("keypress",e._keypressEventHandler(),!1)}else{q.attachEvent("onclick",e._breadcrumbEventHandler("click"))
q.attachEvent("onkeypress",e._keypressEventHandler())}var a=U.chrome,i=!(a&&a.app&&a.app.runtime)&&U.history&&history.pushState&&history.replaceState
if(t.location&&i){var s=U.onpopstate
...
j(history,"pushState",l,r)
j(history,"replaceState",l,r)}if(t.console&&"console"in U&&console.log){var p=function(t,r){e.captureBreadcrumb({message:t,level:r.level,category:"console"})}
_(["debug","info","warn","error","log"],(function(e,t){P(console,t,p)}))}},_restoreBuiltIns:function(){for(var e;this._wrappedBuiltIns.length;){var t=(e=this._wrappedBuiltIns.shift())[0],r=e[1],n=e[2]
...
try{for(;n--;)r[T[n]]=t[n]||""}catch(t){throw new l("Invalid DSN: "+e)}if(r.pass&&!this._globalOptions.allowSecretKey)throw new l("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key")
...
break}n[a].in_app=!1}}return n=n.slice(0,this._globalOptions.stackTraceLimit)},_normalizeFrame:function(e,t){var r={filename:e.url,lineno:e.line,colno:e.column,function:e.func||"?"}
e.url||(r.filename=t)
...
if((!this._globalOptions.ignoreUrls.test||!this._globalOptions.ignoreUrls.test(r))&&(!this._globalOptions.whitelistUrls.test||this._globalOptions.whitelistUrls.test(r))){var u=x({exception:{values:[{type:e,value:t,stacktrace:l}]},culprit:r},a)
...
this._hasNavigator&&N.userAgent&&(e.headers={"User-Agent":navigator.userAgent})
if(this._hasDocument){q.location&&q.location.href&&(e.url=(0,a.redactSensitiveUrlParams)(q.location.href))
if(q.referrer){e.headers||(e.headers={})
e.headers.Referer=(0,a.redactSensitiveUrlParams)(q.referrer)}}return e}},_resetBackoff:function(){this._backoffDuration=0
this._backoffStart=null},_shouldBackoff:function(){return this._backoffDuration&&I()-this._backoffStart<this._backoffDuration},_isRepeatData:function(e){if(e.isPageEvent)return!1
...
this._backoffStart=I()}}},_send:function(e){var t=this._globalOptions,r={project:this._globalProject,logger:t.logger,platform:"javascript"},n=this._getHttpData()
n&&(r.request=n)
e.trimHeadFrames&&delete e.trimHeadFrames;(e=x(r,e)).tags=x(x({},this._globalContext.tags),e.tags)
e.extra=x(x({},this._globalContext.extra),e.extra)
...
e&&!m(e)&&(b(t.shouldSendCallback)&&!t.shouldSendCallback(e)||(this._shouldBackoff()?this._logDebug("warn","Raven dropped error due to backoff: ",e):"number"==typeof t.sampleRate?Math.random()<t.sampleRate&&this._sendProcessedPayload(e):this._sendProcessedPayload(e)))},_getUuid:function(){return k()},_sendProcessedPayload:function(e,t){var r=this,n=this._globalOptions
...
t&&t(n)}})}else this._logDebug("warn","Raven dropped repeat event: ",e)}},_makeRequest:function(e){var t=U.XMLHttpRequest&&new U.XMLHttpRequest
...
t.send(s(e.data))}}},_logDebug:function(e){this._originalConsoleMethods[e]&&this.debug&&Function.prototype.apply.call(this._originalConsoleMethods[e],this._originalConsole,[].slice.call(arguments,1))},_mergeContext:function(e,t){g(t)?delete this._globalContext[e]:this._globalContext[e]=x(this._globalContext[e]||{},t)}}
B.prototype.setUser=B.prototype.setUserContext
B.prototype.setReleaseContext=B.prototype.setRelease},uESY:function(e){var t="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{}
...
return new RegExp(r.join("|"),"i")}function v(e){var t=[]
p(e,(function(e,r){t.push(encodeURIComponent(e)+"="+encodeURIComponent(r))}))
return t.join("&")}function m(e){var t=e.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$/)
if(!t)return{}
var r=t[6]||"",n=t[8]||""
...
return("x"===e?t:3&t|8).toString(16)}))}function x(e,t){return!!(!!e^!!t)}function y(e,t){if(x(e,t))return!1
e=e.values[0]
t=t.values[0]
...
x()}else if(c&&n.isError(c))b(o.computeStackTrace(c),!0)
else{var p={url:r,line:a,column:i},f=void 0,h=t
if("[object String]"==={}.toString.call(t)){var g
if(g=t.match(l)){f=g[1]
h=g[2]}}p.func=s
b({name:f,message:h,url:u(),stack:[p]},!0)}return!!e&&e.apply(this,arguments)}function m(){if(!t){e=a.onerror
a.onerror=v
t=!0}}function _(){if(t){a.onerror=e
t=!1
e=void 0}}function x(){var e=d,t=c
c=null
d=null
p=null
b.apply(null,[e,!1].concat(t))}function y(e,t){var r=i.call(arguments,1)
if(d){if(p===e)return
x()}var n=o.computeStackTrace(e)
d=n
p=e
c=r
setTimeout((function(){p===e&&x()}),n.incomplete?2e3:0)
...
e=s}return p(e,t)},v=(e,t)=>{if(null!=t)throw new Error(l)
return h(g(e))},m=v,_=e=>"prod"===m(e),x=e=>"qa"===m(e),y=()=>{const e=u("HUBLET")
if(e)return e
for(const e of i)if(e.test(t.hostname))return e.exec(t.hostname)[1]
return"na1"}
function E({isNa1:e,isNonNa1:t},r){r||(r=y())
...
return"true"===`${r}`.toLowerCase()},get:g,getHublet:y,getInternal:v,getShort:m,isProd:_,isQa:x,ifHublet:E,normalize:f,set:b,setDebug:(e,t=!0)=>{if("string"==typeof e)try{t?localStorage.setItem(`${e.toUpperCase()}_DEBUG`,JSON.stringify(!0)):localStorage.removeItem(`${e.toUpperCase()}_DEBUG`)}catch(r){p(`${e.toUpperCase()}_DEBUG`,t||void 0)}else{t=null==e||e
...
return window.hubspot}()},ujJg:function(e){function t(e){return e&&e.__esModule?e:{default:e}}e.exports=t,e.exports.__esModule=!0,e.exports.default=e.exports}},n={}
...
//# sourceMappingURL=//static.hsappstatic.net/head-dlb/static-1.3234/bundle.production.js.map